...
const content = {
  en: {
    ...
    metaDescription: "NeoSyrPharm helps international pharmaceutical and biotechnology companies enter, establish, and grow in the Syrian market.",
    socialTitle: "NeoSyrPharm | Pharmaceutical Commercialization in Syria",
    socialDescription: "A strategic partner for sustainable pharmaceutical commercialization in the Syrian market.",
    languageLabel: "Choose language",
    logoHome: "NeoSyrPharm home",
    logoAlt: "NeoSyrPharm logo",
    primaryNav: "Primary navigation",
    statsLabel: "Company highlights",
    heroImageAlt: "Pharmaceutical syringe and medicine vials",
    aboutImageAlt: "NeoSyrPharm pharmaceutical partnership team",
    nav: [["About Us", "about"], ["Capabilities", "capabilities"], ["Market Entry", "market"], ["Experience", "experience"], ["Operational Infrastructure", "infrastructure"], ["Contact Us", "contact"]],
    partner: "Start a Partnership",
    hero: {
      eyebrow: "PHARMACEUTICAL MARKET ACCESS • SYRIA",
      title: "Your Strategic Pharmaceutical Commercialization Partner in Syria",
      intro: "NeoSyrPharm helps international pharmaceutical and biotechnology companies enter, establish and grow in the Syrian market.",
      explore: "Explore Our Capabilities",
      discuss: "Discuss a Partnership",
      promise: "Building pharmaceutical brands for long-term market leadership in Syria."
    },
    labels: [["MARKET ACCESS", "Strategic local entry"], ["QUALITY", "Responsible execution"], ["NATIONWIDE REACH", "Coordinated coverage"]],
    stats: [["22+", "Years of market experience"], ["Nationwide", "Commercial coverage"], ["Full lifecycle", "Support from entry to growth"], ["Institutional", "Access expertise"]],
    aboutLabel: "ABOUT NEOSYRPHARM",
    ...
    coverage: ["NATIONWIDE COVERAGE", "Coverage where care happens.", "A coordinated field and channel model supports major urban centers and institutional accounts."],
    ...
    footerContent: {
      description: "Strategic partner for pharmaceutical commercialization in Syria.",
      linksTitle: "Quick Links",
      links: ["About Us", "Capabilities", "Market Entry", "Experience", "Operational Infrastructure", "Contact Us"],
      partnershipTitle: "Start a Partnership",
      partnershipText: "Let’s build a sustainable pharmaceutical presence in the Syrian market.",
  ...
  ar: {
    pageTitle: "NeoSyrPharm | تسويق المستحضرات الدوائية في سوريا",
  ...
  tr: {
    pageTitle: "NeoSyrPharm | Suriye’de İlaç Ticarileştirme",
    skip: "İçeriğe geç",
    menuOpen: "Menüyü aç",
    menuClose: "Menüyü kapat",
    metaDescription: "NeoSyrPharm, uluslararası ilaç ve biyoteknoloji şirketlerinin Suriye pazarına girmesine, yerleşmesine ve büyümesine yardımcı olur.",
    socialTitle: "NeoSyrPharm | Suriye’de İlaç Ticarileştirme",
    socialDescription: "Suriye pazarında sürdürülebilir ilaç ticarileştirmesi için stratejik ortak.",
    languageLabel: "Dil seçin",
    logoHome: "NeoSyrPharm ana sayfa",
    logoAlt: "NeoSyrPharm logosu",
    primaryNav: "Ana navigasyon",
    statsLabel: "Şirketin öne çıkanları",
    heroImageAlt: "İlaç şırıngası ve ilaç flakonları",
    aboutImageAlt: "NeoSyrPharm ilaç ortaklığı ekibi",
    nav: [["Hakkımızda", "about"], ["Yetkinliklerimiz", "capabilities"], ["Pazara Giriş", "market"], ["Deneyimimiz", "experience"], ["Operasyonel Altyapı", "infrastructure"], ["İletişim", "contact"]],
    partner: "İş Birliği Başlatın",
    hero: {
      eyebrow: "İLAÇ PAZARINA ERİŞİM • SURİYE",
      title: "Suriye’de Stratejik İlaç Ticarileştirme Ortağınız",
      intro: "NeoSyrPharm, uluslararası ilaç ve biyoteknoloji şirketlerinin Suriye pazarına girmesine, yerleşmesine ve büyümesine yardımcı olur.",
      explore: "Yetkinliklerimizi Keşfedin",
      discuss: "İş Birliğini Görüşelim",
      promise: "Suriye’de uzun vadeli pazar liderliği için güçlü ilaç markaları oluşturuyoruz."
    },
    labels: [["PAZARA ERİŞİM", "Stratejik yerel giriş"], ["KALİTE", "Sorumlu uygulama"], ["ÜLKE ÇAPINDA ERİŞİM", "Koordineli kapsama"]],
    stats: [["22+", "Yıllık pazar deneyimi"], ["Ülke çapında", "Ticari kapsama"], ["Tam yaşam döngüsü", "Girişten büyümeye destek"], ["Kurumsal", "Erişim uzmanlığı"]],
    aboutLabel: "NEOSYRPHARM HAKKINDA",
    ...
    coverage: ["ÜLKE ÇAPINDA KAPSAMA", "Bakımın sunulduğu her yerde erişim.", "Koordineli saha ve kanal modelimiz büyük şehirleri ve kurumsal hesapları destekler."],
    ...
    footerContent: {
      description: "Suriye’de ilaçların ticarileştirilmesi için stratejik ortak.",
      linksTitle: "Hızlı Bağlantılar",
      links: ["Hakkımızda", "Yetkinliklerimiz", "Pazara Giriş", "Deneyimimiz", "Operasyonel Altyapı", "İletişim"],
      partnershipTitle: "İş Birliği Başlatın",
      partnershipText: "Suriye pazarında sürdürülebilir bir ilaç varlığı oluşturalım.",
      contactButton: "İletişime Geçin",
      noticeLabel: "Tıbbi bilgilendirme",
      backToTop: "Başa dön"
    },
    validation: {
...
function translatedValue(translations, path) {
  return valueByPath(translations, path) ?? valueByPath(content.en, path);
}
...
const complianceIcons = [
  `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7 3h8l4 4v14H7z"/><path d="M15 3v5h5M10 13h6M10 17h6"/></svg>`,
  `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3 4 6v5c0 5.2 3.4 8.5 8 10 4.6-1.5 8-4.8 8-10V6z"/><path d="m8.5 12 2.2 2.2 4.8-5"/></svg>`,
  `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3v18M5 7h14M7 7l-3 6h6zm10 0-3 6h6zM8 21h8"/></svg>`,
  `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 19V9M10 19V5M16 19v-7M22 19H2"/><path d="m4 7 6-4 6 7 6-5"/></svg>`
];

const credentialIcon = `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7 3h8l4 4v14H7z"/><path d="M15 3v5h5M10 13h6M10 17h4"/></svg>`;

const aboutValueIcons = [
  `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Z"/><path d="M3.6 9h16.8M3.6 15h16.8M12 3c2.2 2.5 3.2 5.5 3.2 9s-1 6.5-3.2 9c-2.2-2.5-3.2-5.5-3.2-9S9.8 5.5 12 3Z"/></svg>`,
  `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="m9 3 6 18M15 3 9 21M7.5 7h9M6.5 12h11M7.5 17h9"/></svg>`,
  `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3 4 7v5c0 4.8 3.2 7.8 8 9 4.8-1.2 8-4.2 8-9V7z"/><path d="m8.5 12 2.2 2.2 4.8-5"/></svg>`,
  `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 21a8 8 0 1 0-8-8"/><path d="M4 8v5h5M12 8v5l3 2"/></svg>`
];

const capabilityIcons = [
  `<svg viewBox="0 0 24 24"><path d="M4 19 20 5M6 5h6v6M12 19h6v-6"/></svg>`,
  `<svg viewBox="0 0 24 24"><path d="M7 3h8l4 4v14H7zM15 3v5h5M10 13h6M10 17h4"/></svg>`,
  `<svg viewBox="0 0 24 24"><path d="M9 3h6v6h-6zM5 15h6v6H5zM13 15h6v6h-6zM12 9v3M8 15v-3h8v3"/></svg>`,
  `<svg viewBox="0 0 24 24"><path d="M4 19V9M10 19V5M16 19v-7M22 19H2"/></svg>`,
  `<svg viewBox="0 0 24 24"><path d="M3 20h18M6 20V9h12v11M9 9V5h6v4M9 13h2M13 13h2M9 17h2M13 17h2"/></svg>`,
  `<svg viewBox="0 0 24 24"><path d="M3 7h12v10H3zM15 10h3l3 3v4h-6M7 20a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM18 20a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/></svg>`,
  `<svg viewBox="0 0 24 24"><path d="M12 3 4 6v5c0 5 3.3 8.2 8 10 4.7-1.8 8-5 8-10V6zM9 12l2 2 4-5"/></svg>`,
  `<svg viewBox="0 0 24 24"><path d="M4 18V8M10 18V4M16 18v-6M22 18H2M4 6l6-4 6 7 6-5"/></svg>`
];
...
function closeMenu() {
  ...
  document.querySelector(".navBackdrop").classList.remove("open");
  document.body.classList.remove("menu-open");
  menu.setAttribute("aria-expanded", "false");
  menu.setAttribute("aria-label", content[currentLanguage].menuOpen);
}
...
function updateActiveNavigation() {
  const sectionIds = content[currentLanguage].nav.map(([, id]) => id);
  const activeId = sectionIds.reduce((active, id) => {
    const section = document.getElementById(id);
    return section && section.getBoundingClientRect().top <= 150 ? id : active;
  }, "");
...
function setLanguage(language) {
  ...
  document.querySelector('meta[property="og:locale"]').content = language === "ar" ? "ar_SY" : language === "tr" ? "tr_TR" : "en_US";
  ...
  document.querySelectorAll("[data-text]").forEach(element => {
    const translated = translatedValue(t, element.dataset.text);
    if (translated !== undefined) element.textContent = translated;
  });

  document.querySelectorAll("[data-alt]").forEach(element => {
    const translated = translatedValue(t, element.dataset.alt);
    if (translated !== undefined) element.alt = translated;
  });

  document.querySelectorAll("[data-aria-label]").forEach(element => {
    const translated = translatedValue(t, element.dataset.ariaLabel);
  ...
  document.querySelectorAll("[data-mobile-lang]").forEach(button => {
    const selected = button.dataset.mobileLang === language;
    button.classList.toggle("on", selected);
    button.setAttribute("aria-pressed", String(selected));
  });
  document.querySelector(".currentLanguage").textContent = language.toUpperCase();
  document.querySelector(".languageToggle").setAttribute("aria-label", t.languageLabel);
  document.querySelector(".footerCta > span:last-child").textContent = language === "ar" ? "←" : "→";

  document.querySelector("#main-nav").innerHTML = `
    <div class="mobileNavHead">
      <img src="assets/logo.png" alt="${t.logoAlt}">
      <button class="mobileNavClose" type="button" aria-label="${t.menuClose}">
        <span aria-hidden="true">×</span>
      </button>
    </div>
    ${t.nav.map(([label, id]) => `<a href="#${id}">${label}</a>`).join("")}
    <div class="mobileLanguages" aria-label="${t.languageLabel}">
      <button type="button" data-mobile-lang="en">EN</button>
      <button type="button" data-mobile-lang="tr">TR</button>
      <button type="button" data-mobile-lang="ar">AR</button>
    </div>
    <a class="mobileNavCta" href="#contact">${t.partner}</a>
  `;
  document.querySelectorAll("[data-mobile-lang]").forEach(button => {
    const selected = button.dataset.mobileLang === language;
    button.classList.toggle("on", selected);
  ...
  document.querySelector("#stats").innerHTML = t.stats.map(([value, label], index) => `<article><span>0${index + 1}</span><div><strong>${value}</strong><p>${label}</p></div></article>`).join("");
  document.querySelector("#about-values").innerHTML = t.aboutValues.map((value, index) => `
    <article>
      <span aria-hidden="true">${aboutValueIcons[index]}</span>
      <strong>${value}</strong>
    </article>
  `).join("");
  ...
  document.querySelector("#quality-points").innerHTML = t.quality[3].map((point, index) => `
    <li>
      <span class="qualityIcon" aria-hidden="true">${complianceIcons[index]}</span>
      <strong>${point}</strong>
    </li>
  `).join("");
  ...
  if (activeSubmitButton.disabled) {
    ...
    document.querySelector(".formStatus").textContent = t.formProcessing;
  }

  try {
    localStorage.setItem("neosyrpharm-language", language);
  } catch (error) {
...
document.querySelector(".menu").addEventListener("click", event => {
  ...
  document.querySelector(".navBackdrop").classList.toggle("open", isOpen);
  document.body.classList.toggle("menu-open", isOpen);
  event.currentTarget.setAttribute("aria-expanded", String(isOpen));
  event.currentTarget.setAttribute("aria-label", isOpen ? content[currentLanguage].menuClose : content[currentLanguage].menuOpen);
});

document.querySelector("#main-nav").addEventListener("click", event => {
  if (event.target.closest(".mobileNavClose")) {
    closeMenu();
    document.querySelector(".menu").focus();
    return;
  }
  const languageButton = event.target.closest("[data-mobile-lang]");
  if (!languageButton) return;
  setLanguage(languageButton.dataset.mobileLang);
  closeMenu();
});
...
document.querySelector(".languageToggle").addEventListener("click", event => {
  ...
  event.currentTarget.setAttribute("aria-expanded", String(isOpen));
  if (isOpen) languageMenu.querySelector('[aria-checked="true"]')?.focus();
});

document.querySelector(".languageSwitcher").addEventListener("keydown", event => {
  const items = Array.from(document.querySelectorAll(".languageMenu [data-lang]"));
  const index = items.indexOf(document.activeElement);

  if (event.key === "ArrowDown" || event.key === "ArrowUp") {
    event.preventDefault();
    if (document.querySelector(".languageMenu").hidden) {
...
document.addEventListener("keydown", event => {
  if (event.key === "Escape") {
    const navigationWasOpen = document.querySelector("#main-nav").classList.contains("open");
    const languageWasOpen = !document.querySelector(".languageMenu").hidden;
    closeMenu();
    closeLanguageMenu();
    if (navigationWasOpen) document.querySelector(".menu").focus();
    else if (languageWasOpen) document.querySelector(".languageToggle").focus();
  }
});
...
document.querySelector(".partnershipCtaButton").addEventListener("click", event => {
  event.preventDefault();
...
function clearContactErrors() {
  document.querySelectorAll("#contact-form input, #contact-form textarea").forEach(clearFieldError);
  const status = document.querySelector(".formStatus");
  if (status) status.textContent = "";
}

function validateContactForm(form) {
  const validation = content[currentLanguage].validation || content.en.validation;
...
document.querySelector("#contact-form").addEventListener("submit", event => {
  ...
  buttonLabel.textContent = t.formProcessing;
...
function updatePageProgress() {
  ...
  document.querySelector(".scroll-progress span").style.width = `${Math.min(progress, 100)}%`;
  document.querySelector(".header").classList.toggle("scrolled", window.scrollY > 18);
  updateProcessProgress();
  updateActiveNavigation();
}
...
function updateProcessProgress() {
  ...
  if (!process || !process.children.length) return;

  const section = process.closest(".partnershipMethod");
  const stickyInner = section.querySelector(".partnershipMethodInner");
  const sectionRect = section.getBoundingClientRect();
  const navbarHeight = parseFloat(
    getComputedStyle(document.documentElement).getPropertyValue("--navbar-height")
  ) || 0;
  const usesSticky = getComputedStyle(stickyInner).position === "sticky";
  const start = usesSticky ? navbarHeight : window.innerHeight * 0.82;
  const distance = usesSticky
    ? Math.max(sectionRect.height - stickyInner.offsetHeight, 1)
    : Math.max(sectionRect.height + window.innerHeight * 0.52, 1);
  const progress = Math.min(Math.max((start - sectionRect.top) / distance, 0), 1);
  const steps = Array.from(process.children);
...
try {
  const savedLanguage = localStorage.getItem("neosyrpharm-language");
  if (content[savedLanguage]) initialLanguage = savedLanguage;
} catch (error) {
